...
export default function JobApplicantForm() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:5000/JobApplicantLogin", {
                method: "POST",
    ...
    <div className='loginmain d-flex justify-content-center align-items-center m-3 p-4 vh-100'>
      ...
      <div className='loginform-container'>
        ...
        <div className='loginform '>
            ...
            <p className='p-3'>Didn't have an account? <a className='loginform-link' href="JobApplicantRegister">Register</a></p>
            </div>
            </form>
